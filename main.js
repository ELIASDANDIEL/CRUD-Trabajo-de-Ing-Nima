...
$(document).on("click", ".btnEditar", function(){
    ...
    cu = parseInt(fila.find('td:eq(6)').text());
...
$("#formPersonas").submit(function(e){
    ...
    $.ajax({
        ...
        type: "POST",
        dataType: "json",
        data: { nombres:nombres, apellidos:apellidos, provincia:provincia, ciudad:ciudad, edad:edad, cu:cu, id:id, opcion:opcion},
        ...
        success: function(data){  
            ...
            edad = data[0].edad;
            cu = data[0].cu;
            if(opcion == 1){tablaPersonas.row.add([id,nombres,apellidos,provincia,ciudad,edad,cu]).draw();}
            else{tablaPersonas.row(fila).data([id,nombres,apellidos,provincia,ciudad,edad,cu]).draw();}            
        }        
    });
